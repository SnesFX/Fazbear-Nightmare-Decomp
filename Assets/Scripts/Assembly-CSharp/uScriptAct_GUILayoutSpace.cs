...
public class uScriptAct_GUILayoutSpace : uScriptLogic
{
	...
	public void In([FriendlyName("Width", "The width of the space. \n\nNote: This will override the ExpandWidth and ExpandHeight layout options in the group.")] float Width, [FriendlyName("Flexible", "When True, inserts a flexible space element and ignores any specified Width. Flexible spaces use up any leftover space in a layout.")] bool Flexible)
	{
		if (Flexible)
		{
