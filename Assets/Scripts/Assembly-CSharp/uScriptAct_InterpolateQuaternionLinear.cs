...
public class uScriptAct_InterpolateQuaternionLinear : uScriptLogic
{
	...
	public bool Driven(out Quaternion currentValue)
	{
		...
		if (flag)
		{
			m_LastValue = Quaternion.Lerp(m_Start, m_End, currentTime);
		}
		currentValue = m_LastValue;
		return flag;
	}
