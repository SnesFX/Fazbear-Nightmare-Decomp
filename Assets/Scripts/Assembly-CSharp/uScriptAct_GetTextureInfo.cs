...
public class uScriptAct_GetTextureInfo : uScriptLogic
{
	...
	public void In([FriendlyName("Target", "The target Texture2D variable.")] Texture2D target, [FriendlyName("Width", "The width of the texture as an int variable.")] out int width, [FriendlyName("Height", "The height of the texture as an int variable.")] out int height, [FriendlyName("Size", "The size of the texture as a Vector2 variable (width, height).")][SocketState(false, false)] out Vector2 size, [FriendlyName("Filter Mode", "The current filter mode of the texture.")][SocketState(false, false)] out FilterMode filterMode, [FriendlyName("Anisotropic Level", "The current anisotropic filtering level of the texture.")][SocketState(false, false)] out int anisoLevel, [SocketState(false, false)][FriendlyName("Wrap Mode", "The current wrap mode setting of the texture (Repeat or Clamp).")] out TextureWrapMode wrapMode, [FriendlyName("Mip Map Bias", "The current mip map bias of the texture.")][SocketState(false, false)] out float mipMapBias, [FriendlyName("Texture Name", "The current name of the Texture2D as a string variable.")][SocketState(false, false)] out string name)
	{
		if (null != target)
		{
