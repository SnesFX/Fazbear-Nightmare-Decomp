...
public class uScriptAct_SetPreferenceKeyInt : uScriptLogic
{
	...
	public void In([FriendlyName("Key Name", "The name of the preference key you wish to set the value for.")] string KeyName, [FriendlyName("Value", "The new value of the key.")] int Value)
	{
