...
public class uScriptAct_ControlGameObjectRotate : uScriptLogic
{
	...
	public void In([FriendlyName("Target", "The Target GameObject to be rotated.")] GameObject Target, [FriendlyName("Direction", "The direction to rotated the target.")][SocketState(false, false)] Direction rotateDirection, [FriendlyName("Speed", "The speed you wish to rotated the target per tick. This uses a relativly small value for most cases.")][DefaultValue(0.1f)] float Speed, [FriendlyName("Use Local", "Rotate the GameObject in local coordinates.")][SocketState(false, false)][DefaultValue(false)] bool useLocal)
	{
