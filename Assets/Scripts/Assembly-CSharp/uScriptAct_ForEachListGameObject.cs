...
public class uScriptAct_ForEachListGameObject : uScriptLogic
{
	...
	public void In([FriendlyName("List", "The list to iterate over.")] GameObject[] GameObjectList, [FriendlyName("Current", "The item for the current loop iteration.")] out GameObject go, [FriendlyName("Current Index", "The index value for the current loop iteration.")][SocketState(false, false)] out int currentIndex)
	{
		if (m_List == null)
		{
			m_List = GameObjectList;
